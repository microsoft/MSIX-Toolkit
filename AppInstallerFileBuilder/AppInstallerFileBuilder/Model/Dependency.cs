...
{
    [DataContract(Name = "Dependencies")]
    public class Dependency : INotifyPropertyChanged
    {
        ...
        public Dependency(String filePath, String version, String publisher, String name, PackageType packageType, String processorArchitecture, String uriPath)
        {
            _filePath = filePath;
            _version = version;
