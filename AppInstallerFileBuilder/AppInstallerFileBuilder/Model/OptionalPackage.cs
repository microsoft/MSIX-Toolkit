...
{
    [DataContract(Name = "OptionalPackages")]
    public class OptionalPackage : INotifyPropertyChanged
    {
        ...
        public OptionalPackage(String filePath, String version, String publisher, String name, PackageType packageType, String processorArchitecture, String uriPath)
        {
            _filePath = filePath;
            _version = version;
